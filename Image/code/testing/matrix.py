...
def process_image(image_path, output_path):
    ...
    # Save the matrix of the masked and thresholded image to a file
    matrix_file = os.path.join(
        output_path, f"{os.path.splitext(os.path.basename(image_path))[0]}_matrix.txt"
    )
    np.savetxt(matrix_file, masked_image, fmt="%d")
...
if __name__ == "__main__":
    ...
    output_directory = r"C:\Users\Anuj Bohra\Desktop\IIT_Patna\anujwarp\blahblahImages"
